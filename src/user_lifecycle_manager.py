...
from src.ocserv_adapter import OcservPaths, applyManagedMutation, createUserRecord, deleteUserRecord, disableUserRecord, loadUsers, serializeActivationResult
...
def createUser(
    ...
    applied = applyManagedMutation(
        paths,
        "create_user",
        lambda: createUserRecord(paths, username, requested_group),
        username=username,
